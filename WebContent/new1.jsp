...
<head>
  ...
  <link rel="stylesheet" href="styles.css">
   <script src="https://kit.fontawesome.com/9a18746013.js"></script>
  ...
  <section id="title">
   <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
         ...
         <a class="navbar-brand" href=""><i class="fas fa-tint"></i>Raktdan</a>
...
<li class="nav-item">
  <a class="nav-link" href="#title">General</a>
 </li>
 <li class="nav-item">
...
<div col-lg-6>
  ...
  <section id="features">
    ...
    <h3> Easy to use.</h3>
    <p>So easy to use, that anyone could do it.</p>
  </div>
       <div class="feature-box col-lg-4">
        <i class="icon fas fa-bullseye fa-4x"></i>
    <h3> Elite Clientele</h3>
    <p>We have all types of blood groups,and easy availability.</p>
</div>
<div class="feature-box col-lg-4">
  <i class="icon fas fa-heart fa-4x"></i>
    <h3> Guaranteed to work.</h3>
    <p>Any blood group will be made available,in all possible manner.</p>
    </div>
</div>
  </section>
  ...
  <section id="pricing">
    ...
    <h2 class="s-color">SERVICES</h2>
    <p>Raktdan is an initiative to connect, digitize and streamline the work flow of blood banks across the nation.</p>
   ...
   <div class="row">
     ...
     <div class="card-body">
       <div class="service-icon hvr-bounce-to-top svcStock">
     ...
     <div class="card-body">
       ...
       <p class="card-content">View and register for Blood Donation camps</p>
       <button type="button" class="aman btn btn-lg btn-block btn-dark">Sign Up</button>
  ...
  <section id="cta">
    ...
    <h3 class="cta-head"> “Don't let fools or mosquitoes suck your blood, put it to good use".</h3>
    <button type="button" class="btn btn-dark btn-lg download-button1"><i class="fab fa-apple"></i> Download</button>
    <button type="button" class="btn btn-outline-light btn-lg download-button1"><i class="fab fa-google-play"></i> Download</button>
  ...
  <footer id="footer">
    <i class="icon1 fa fa-twitter"></i>
    <i class="icon1 fa fa-facebook"></i>
    <i class="icon1 fa fa-instagram"></i>
    <i class="icon1 fa fa-envelope"></i>
    <p>© Copyright 2020 raktdan</p>
